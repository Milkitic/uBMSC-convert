...
this.TBAssociate.Click += new EventHandler(TBAssociate_Click);
...
this.TBAssociatePMS.Click += new EventHandler(TBAssociatePMS_Click);
        this.TBAssociateIBMSC = new System.Windows.Forms.Button();
this.TBAssociateIBMSC.Click += new EventHandler(TBAssociateIBMSC_Click);
...
this.cAutoSave.CheckedChanged += new EventHandler(cAutoSave_CheckedChanged);
...
this.TBAssociateBME.Click += new EventHandler(TBAssociateBME_Click);
        this.TBAssociateBML = new System.Windows.Forms.Button();
this.TBAssociateBML.Click += new EventHandler(TBAssociateBML_Click);
...
this.cBpm1296.Size = new System.Drawing.Size(253, 19);
...
this.cStop1296.Size = new System.Drawing.Size(198, 19);
...
this.NAutoSave.Maximum = new decimal(new int[4] { 60, 0, 0, 0 });
this.NAutoSave.Minimum=new decimal(new int[4] { 1, 0, 0, 0 });
        this.NAutoSave.Name = "NAutoSave";
this.NAutoSave.Size = new System.Drawing.Size(62, 23);
        this.NAutoSave.TabIndex = 7;
this.NAutoSave.Value=new decimal(new int[4] { 2, 0, 0, 0 });
...
this.nGridPartition.Maximum=new decimal(new int[4] { 10000, 0, 0, 0 });
this.nGridPartition.Minimum=new decimal(new int[4] { 8, 0, 0, 0 });
...
this.nGridPartition.Value=new decimal(new int[4] { 192, 0, 0, 0 });
