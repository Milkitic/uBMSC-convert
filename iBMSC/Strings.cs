...
public class Strings
{
    ...
    public class Messages
    {
        ...
        public static string SaveOnExit1 =
            "You should tell me if you want to save changes before closing the computer. -_,-";

        public static string SaveOnExit2 =
        ...
        public static string PreferencePostpone =
            "The preference will take effect on the next start-up of the program.";
        ...
        public static string NoteOverlapError =
        ...
        public static string RestoreAutosavedFile =
            "{} autosaved file(s) have been found. Do you want to recover these files?";
    }
