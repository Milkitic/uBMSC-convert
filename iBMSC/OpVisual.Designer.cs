...
this.cAdjustLengthBorder.Click += new EventHandler(BCClick);
        this.cSelectedBorder = new System.Windows.Forms.Button();
this.cSelectedBorder.Click += new EventHandler(BCClick);
        this.cMouseOver = new System.Windows.Forms.Button();
this.cMouseOver.Click += new EventHandler(BCClick);
...
this.cTSSplitter.Click += new EventHandler(BCClick);
...
this.cTSMouseOver.Click += new EventHandler(BCClick);
...
this.iHiddenNoteOpacity.Increment = new decimal(new int[4] { 1, 0, 0, 65536 });
this.iHiddenNoteOpacity.Location = new System.Drawing.Point(537, 148);
this.iHiddenNoteOpacity.Maximum=new decimal(new int[4] { 1, 0, 0, 0 });
...
this.iLongLabelHorizShift.Minimum=new decimal(new int[4] { 100, 0, 0, -2147483648 });
...
this.iLabelHorizShift.Minimum=new decimal(new int[4] { 100, 0, 0, -2147483648 });
...
this.iLabelVerticalShift.Minimum=new decimal(new int[4] { 100, 0, 0, -2147483648 });
...
this.iTSSensitivity.Maximum=new decimal(new int[4] { 20, 0, 0, 0 });
...
this.iTSSensitivity.Value=new decimal(new int[4] { 1, 0, 0, 0 });
...
this.iMiddleSensitivity.Maximum=new decimal(new int[4] { 1000000, 0, 0, 0 });
...
this.iMiddleSensitivity.Value=new decimal(new int[4] { 1, 0, 0, 0 });
