...
public partial class OpVisual : Form
{
    ...
    public OpVisual(visualSettings xvo, Column[] xcol, Font monoFont)
    {
        ...
        self.SetValClamped(new decimal(vo.kHeight));
        iNoteHeight = self;
        self = iLabelVerticalShift;
        self.SetValClamped(new decimal(vo.kLabelVShift));
        iLabelVerticalShift = self;
        self = iLabelHorizShift;
        self.SetValClamped(new decimal(vo.kLabelHShift));
        iLabelHorizShift = self;
        self = iLongLabelHorizShift;
        self.SetValClamped(new decimal(vo.kLabelHShiftL));
        iLongLabelHorizShift = self;
        self = iHiddenNoteOpacity;
        self.SetValClamped(new decimal(vo.kOpacity));
        iHiddenNoteOpacity = self;
        self = iTSSensitivity;
        self.SetValClamped(new decimal(vo.PEDeltaMouseOver));
        iTSSensitivity = self;
        self = iMiddleSensitivity;
        self.SetValClamped(new decimal(vo.MiddleDeltaRelease));
